...
print("most played playlist  :", most_played.select("agg_playlist_id"))
...
print("most played map  :", most_map.select("agg_mapid"))
...
print("map where most Killing Spree medals   :", most_kills_map.select("map_kills"))
